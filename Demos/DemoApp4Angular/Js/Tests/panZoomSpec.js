...
describe('panZoomSpec', function () {
    ...
    it("should contain svg height 700 and width 700", function () {
        expect(element.attr('height')).toBe('700');
        expect(element.attr('width')).toBe('700');
    });

    it("should define zoomIn and zoomOut", function () {
        expect(scope.zoomIn).toBeDefined();

        expect(scope.zoomOut).toBeDefined();
    });

    it("should not call zoomIn method if chkZoomEnabled = false ", function () {
...
//# sourceMappingURL=panZoomSpec.js.map
